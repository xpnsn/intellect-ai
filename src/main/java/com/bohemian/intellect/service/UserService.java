...
public class UserService {
    ...
    public ResponseEntity<String> saveUser(RegistrationRequest request) {
        User user = new User(null, request.username(), request.name(), passwordEncoder.encode(request.password()), request.email(), false, List.of("USER"), Collections.emptyList(), Collections.emptyList());
